...
HD_PWD='C:/Download/static_pipline_CPU/static_pipline_CPU.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log IF_ID.vdi -applog -m64 -messageDb vivado.pb -mode batch -source IF_ID.tcl -notrace
