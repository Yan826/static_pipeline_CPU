...
HD_PWD='C:/Download/static_pipline_CPU/static_pipline_CPU.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log IF_ID.vds -m64 -mode batch -messageDb vivado.pb -notrace -source IF_ID.tcl
